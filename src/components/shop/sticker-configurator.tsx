  ...
  async function handleAddToCart() {
    ...
    startAddTransition(async () => {
      ...
      await addToCart({
        ...
        heightMm,
        shape: shape.code,
        finish: lamination?.code ?? "none",
        material: material.code,
        basePriceCents: priceResult.unitPriceCents,
        options: {},
        customizationNote: customerNote || undefined,
        directUnitPriceCents: priceResult.unitPriceCents,
        stickerConfig: {
          shapeId: shape.id,
